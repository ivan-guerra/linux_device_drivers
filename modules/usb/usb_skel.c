/*
 * usb_skel.c - A USB skeleton driver.
 *
 * For a more up to date example, checkout the USB skeleton driver included in
 * the kernel sources under linux/drivers/usb/usb-skeleton.c.
 *
...
static void skel_write_bulk_callback(struct urb *urb)
{
	...
	if (urb->status &&
		...
		pr_devel("%s - nonzero write bulk status received: %d",
